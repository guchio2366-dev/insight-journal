...
- Agriculture: preserve the rice layer. Add real MapSPAM crop distributions and source-defined livestock/forestry statistics only after validating their units, masks and years.
