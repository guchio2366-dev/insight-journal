export const religionStories=[
 {id:'south-protestant',number:'①',title:'南部のプロテスタント',region:'米国南部',coordinate:[-86.8,33.2] as [number,number],text:'南部では福音派プロテスタントの比重が大きく、バプテスト系をはじめ複数の宗派が重なります。歴史的黒人プロテスタントも地域社会を形づくってきました。「南部は一つの宗派」とまとめず、ダラス、ニューオーリンズ、マイアミの違いも見比べます。',sources:[{label:'Pew：米国南部',url:'https://www.pewresearch.org/religious-landscape-study/region/south/'}]},
 {id:'utah-lds',number:'②',title:'ユタの末日聖徒',region:'ユタ州・ソルトレーク周辺',coordinate:[-111.9,40.75] as [number,number],text:'末日聖徒の開拓者は、敵対や暴力を受けてイリノイ州ノーブーを離れ、19世紀に西方へ移住しました。その共同体形成が、現在もユタで末日聖徒が目立つ歴史的背景です。現在の割合と、移住の経緯は別の根拠で確認します。',sources:[{label:'Pew：ユタ州',url:'https://www.pewresearch.org/religious-landscape-study/state/utah/'},{label:'NPS：移住の歴史',url:'https://www.nps.gov/mopi/learn/historyculture/index.htm'}]},
...
export const populationCityReligionProfiles:Record<string,CityReligion>={
 ...
 'san-francisco':{text:'移民が持ち込んだ宗教と、公共空間で異なる信仰が共存する過程を読む都市です。宗教分類だけで出身地や現在の価値観を決めつけません。',source:'https://pluralism.org/catholic-and-jewish-immigrants',sourceLabel:'Pluralism Project：移民と宗教',stories:['southwest-catholic']},
 'los-angeles':{text:'スペイン植民期の宣教施設の歴史に、その後の国内外からの移住が重なります。ヒスパニックという民族区分をカトリックと同義には扱いません。',source:'https://www.nps.gov/subjects/travelspanishmissions/introduction.htm',sourceLabel:'NPS：南西部の宣教施設',stories:['southwest-catholic']},
 'las-vegas':{text:'人口流入の大きい都市として宗教共同体の多様性を確認します。隣接するユタで目立つ末日聖徒の構成を、ラスベガスへそのまま流用しません。',source:'https://www.pewresearch.org/religious-landscape-study/state/nevada/',sourceLabel:'Pew：ネバダ州',stories:['utah-lds']},
 denver:{text:'山地と平原の接点にある大都市として、州全体と都市圏の範囲を分けて宗教的多様性を読みます。都市を特定の一宗派の代表とは扱いません。',source:'https://www.pewresearch.org/religious-landscape-study/state/colorado/',sourceLabel:'Pew：コロラド州',stories:[]},
 dallas:{text:'南部の福音派・バプテスト系の歴史を読む入口です。同時に大都市圏には異なる宗派や宗教があるため、南部全体を一様には扱いません。',source:'https://www.pewresearch.org/religious-landscape-study/state/texas/',sourceLabel:'Pew：テキサス州',stories:['south-protestant']},
 ...
 'new-orleans':{text:'南部の中で、カトリックと複数のプロテスタントの存在を見比べる都市です。「南部＝福音派」という一つの像では収まらない例として読みます。',source:'https://www.pewresearch.org/religious-landscape-study/state/louisiana/',sourceLabel:'Pew：ルイジアナ州',stories:['south-protestant']},
 ...
 'washington-dc':{text:'黒人教会が地域社会や平等を求める運動で担ってきた役割を読む入口です。ワシントン州の統計とは区別し、首都圏と市域の範囲にも注意します。',source:'https://www.pewresearch.org/religion/2021/02/16/faith-among-black-americans/',sourceLabel:'Pew：黒人の宗教生活',stories:['black-churches']},
