...
export const populationOverviews:Record<string,{title:string;text:string;reading:string}>={
 ...
 religion:{title:'最大グループから、移住と地域社会の歴史を読む',text:'宗教団体が把握したadherentsについて、各郡で人数が最も多いグループを示します。南部、北東部、五大湖周辺、山岳西部を見比べると、移住・入植と地域社会の形成が見えてきます。',reading:'色は過半数や住民全体の宗教構成を意味しません。凡例、都市、①〜⑥の地域を選び、左の分布と右の歴史説明を見比べます。産業や投票との重なりは、個人の特徴を決める因果とは扱いません。'},
