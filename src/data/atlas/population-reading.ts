...
export const populationOverviews:Record<string,{title:string;text:string;reading:string}>={
 distribution:{title:'人は都市に集まり、仕事は都市ごとに異なる',text:'沿岸や五大湖の人口集積を支える仕事は、物流・製造・情報サービスなど地域ごとに異なります。都市の位置と職種を合わせると、人が集まる場所の特徴が見えてきます。',reading:'東西の沿岸、五大湖周辺、内陸の大都市を順に見ます。人口密度は土地1km²あたりの人数。濃い郡のまとまりが人口の集積を示しますが、色の面積は人口の多さではありません。'},
 ethnicity:{title:'定住と移動の歴史が、現在の分布に残る',text:'文化の違いを残して共存する「サラダボウル」の地域差は、植民・奴隷制・国境の変化と、仕事を求める移住が重なって生まれました。',reading:'灰色を背景に、南部の黒人、メキシコ国境沿いのヒスパニック、沿岸のアジア系などの集積を見比べます。白人が最多の郡でも、着色基準に達する集団を色で示します。都市名の複数の色点から、同じ地域に暮らす複数の集団と構成比を確認できます。'},
 religion:{title:'移住先に築いた共同体が、宗教の地域差をつくる',text:'南部のバプテスト、北東部などのカトリック、ユタ周辺の末日聖徒。各地のまとまりには、移住・入植と教会を中心とする共同体の歴史が重なっています。',reading:'南部、北東部、山岳西部を見比べます。色は宗教団体が報告・推計した所属者・子どもなど（adherents）のうち、その郡で最多の個別グループを示します。番号は歴史を読むための代表地点です。'},
 vote:{title:'広く塗られた色と、多く集まる票は別',text:'郡の面積が広くても、票数が多いとは限りません。2024年大統領選の赤青の分布を、都市の位置と郡の実際の票数に照らすと、選挙地図の見え方が変わります。',reading:'赤は共和党、青は民主党の得票率が上回った郡です。色の濃さは両党の差を示します。州を選んで都市周辺を拡大し、郡を押して票数と得票率差を確認できます。'},
};

// Editorial takeaways describe the existing, sourced occupation profiles below.
export const populationCityTakeaways:Record<string,string>={
 seattle:'情報・数理と設計の仕事が集まり、技術開発が都市圏の雇用を特徴づけています。',
 'san-francisco':'情報・金融の専門職と、都市生活を支える医療・介護の仕事が共存しています。',
 'los-angeles':'映像・娯楽の制作と貿易物流が、専門職から輸送まで幅広い仕事につながっています。',
 'las-vegas':'砂漠の都市を支える観光が、宿泊・飲食・接客の大きな雇用を生んでいます。',
 denver:'山脈と平原の接点に、企業活動や技術開発を担う専門職が集まっています。',
 dallas:'物流の現場と企業の事務・管理機能が、テキサス北部の都市圏で重なっています。',
 chicago:'五大湖の物流拠点に、輸送の仕事と大都市の管理機能が集まっています。',
 detroit:'自動車産業の集積は、工場の生産職と設計・開発職の両方に表れています。',
 'new-orleans':'ミシシッピ川下流の港湾と観光が、輸送・飲食の仕事につながっています。',
 miami:'観光と貿易を担う都市では、販売・飲食・事務など顧客を支える仕事が目立ちます。',
 'washington-dc':'首都の行政・専門サービスの集積が、法務・情報・組織運営の仕事に表れています。',
 'new-york':'金融の専門職だけでなく、大きな人口を支える医療・介護も都市の雇用を特徴づけています。',
};
