...
export const populationOverviews:Record<string,{title:string;text:string;reading:string}>={
 ...
 ethnicity:{title:'定住と移動の歴史が、現在の分布に残る',text:'文化の違いを残して共存する「サラダボウル」の地域差は、植民・奴隷制・国境の変化と、仕事を求める移住が重なって生まれました。',reading:'南部、五大湖周辺、メキシコ国境沿いを見比べます。郡（州の下位にある地域単位）ごとに人数が最大の区分を一色で示しています。凡例から、定住の背景と移住先をたどれます。'},
