...
export const populationOverviews:Record<string,{title:string;text:string;reading:string}>={
 distribution:{title:'人は都市に集まり、生活圏は境界を越える',text:'東西の沿岸や五大湖周辺に人口が集まり、内陸にも大都市が点在します。濃い色の広さと、そこに住む人数は別のものです。',reading:'まず都市の周りの濃淡を見ます。NY・LA・ダラスの都市圏では、主要都市の外へ続く市街地と、その先の低密度な地域を比べられます。'},
 ...
 religion:{title:'宗教構成を、移住と地域の歴史から読む',text:'米国ではプロテスタントとカトリックが大きな割合を占め、特定の宗教に属さない人も約3割います。地図の番号をたどると、移住や定住の歴史が地域の宗教文化とどう重なるかを見比べられます。',reading:'①〜⑥は解説する場所の参照点です。信徒の人数、宗教圏の境界、その地域だけにある文化を示すものではありません。都市名と番号を選び、左の場所と右の説明を見比べます。'},
