...
export const populationOverviews:Record<string,{title:string;text:string;reading:string}>={
 ...
 religion:{title:'宗派と無宗教の広がりを読む',text:'プロテスタントとカトリックが大きな割合を占め、無宗教も約3割です。移住や地域の歴史と結びつきますが、民族と宗教は一対一では対応しません。',reading:'現在、州別の原表は未取得です。左の灰色は「無宗教」や0%ではありません。全国値から都市・州の宗教構成は推定していません。'},
