...
{id:'corn-hogs',products:['corn'],label:'作物と養豚',lead:'輪郭で示すとうもろこし産地と、強調した養豚の代表地域を見比べます。中西部で分布が重なる一方、ノースカロライナなどにも養豚地域があります。飼料の近さに加え、飼育・加工・輸送を結ぶ生産体制も立地に関わります。',target:{page:'agriculture',relation:'corn-soy-hogs'},bounds:[-104,33,-79,49],sources:productSources.hogs},
