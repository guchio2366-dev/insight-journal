...
export type CropExplanation = {id:string;name:string;color:string;summary:string;paragraphs:CropParagraph[];uses:string;sources:string[]};
export const cropExplanations:CropExplanation[] = [
  { id: 'corn', name: 'とうもろこし', color: '#ecc759', summary: '夏の温度と水分、広い耕地、飼料・加工・輸送の集積が結びつく。', paragraphs: [
    {"runs": [{"text": "とうもろこしは、"}, {"text": "暖かい生育期", "emphasisKind": "temperature", "pairId": "corn-temperature"}, {"text": "と"}, {"text": "十分な水分", "emphasisKind": "water", "pairId": "corn-water"}, {"text": "がある場所で育ちやすい作物です。また、大型機械での栽培には、"}, {"text": "まとまった平坦な耕地", "emphasisKind": "land", "pairId": "corn-land"}, {"text": "が適しています。米国中西部には"}, {"text": "夏の温度", "emphasisKind": "temperature", "pairId": "corn-temperature"}, {"text": "と"}, {"text": "降水", "emphasisKind": "water", "pairId": "corn-water"}, {"text": "、"}, {"text": "まとまった平坦な耕地", "emphasisKind": "land", "pairId": "corn-land"}, {"text": "があり、生育と大規模栽培それぞれの条件が重なります。"}]},
  ...
  { id: 'soybean', name: '大豆', color: '#a5bb74', summary: '中西部でとうもろこしの栽培域と重なる。重なりは同じ畑での同時栽培を意味しない。', paragraphs: [
    {"runs": [{"text": "大豆も"}, {"text": "生育期の温度と水分", "emphasisKind": "temperature", "pairId": "soybean-temperature"}, {"text": "を必要とします。根粒菌による窒素固定が特徴ですが、肥料が一切不要でも、やせた土地ならどこでも高い収量が得られるわけでもありません。"}]},
    {"runs": [{"text": "米国中西部では、とうもろこしと共通する"}, {"text": "夏の生育条件", "emphasisKind": "temperature", "pairId": "soybean-temperature"}, {"text": "と広い耕地を利用でき、輪作にも組み込まれています。搾油、飼料、輸出のための加工・輸送網も共有できるため、二つの作物が近接してまとまる地域になっています。"}]},
  ...
  { id: 'wheat', name: '小麦', color: '#d5a56c', summary: '北部の春小麦、中央・南部の冬小麦など、作型の違いを含む分布。', paragraphs: [
    {"runs": [{"text": "小麦には、秋にまいて越冬する冬小麦と、春にまく春小麦など、"}, {"text": "異なる気候に合わせた作型", "emphasisKind": "temperature", "pairId": "wheat-growing"}, {"text": "があります。水田のような湛水を必要とせず、"}, {"text": "比較的乾燥した地域でも栽培", "emphasisKind": "water", "pairId": "wheat-water"}, {"text": "されますが、生育期の水分不足は収量を下げます。"}]},
    {"runs": [{"text": "米国では、"}, {"text": "東から西へ降水が減る大平原", "emphasisKind": "water", "pairId": "wheat-water"}, {"text": "や、太平洋岸北西部の内陸などに主要産地があります。"}, {"text": "寒さと雨の時期に合う品種・作型", "emphasisKind": "temperature", "pairId": "wheat-growing"}, {"text": "を選び、広い耕地と集荷・輸送の仕組みを利用してきたことが、地域への定着を支えています。"}]},
  ...
  { id: 'cotton', name: '綿花', color: '#b886b2', summary: '長く暖かい生育期が必要。南東部と、乾燥したテキサス西部では水の条件が異なる。', paragraphs: [
    {"runs": [{"text": "綿花は"}, {"text": "暖かく霜のない生育期間", "emphasisKind": "temperature", "pairId": "cotton-temperature"}, {"text": "を必要とし、収穫期の雨は品質や収穫作業に影響します。ただし、暖かいだけで十分ではなく、"}, {"text": "生育期に利用できる水", "emphasisKind": "water", "pairId": "cotton-water"}, {"text": "も重要です。"}]},
    {"runs": [{"text": "米国南部は"}, {"text": "長い生育期間を確保しやすく", "emphasisKind": "temperature", "pairId": "cotton-temperature"}, {"text": "、綿繰りなどの加工施設とともに綿花産地が形成されました。より乾燥するテキサス西部では"}, {"text": "灌漑の役割が大きい", "emphasisKind": "water", "pairId": "cotton-water"}, {"text": "一方、天水栽培もあり、地域内でも水利用は一様ではありません。歴史的な土地・労働制度と、現在の機械化された生産は、時代を分けて考える必要があります。"}]},
  ...
  { id: 'rice', name: '稲作', color: '#54acd0', summary: '平坦な低地と水管理の組み合わせ。雨の少ないカリフォルニアにも産地がある。', paragraphs: [
    {"runs": [{"text": "水稲では、暖かい生育期に加え、"}, {"text": "田へ水を供給し、必要に応じて排水できること", "emphasisKind": "water", "pairId": "rice-water"}, {"text": "が大切です。したがって、年間降水量の多さだけでは産地を説明できません。"}]},
    {"runs": [{"text": "ミシシッピ川下流や湾岸には平坦な土地が広がり、"}, {"text": "水管理と大規模栽培を組み合わせやすい条件", "emphasisKind": "water", "pairId": "rice-water"}, {"text": "があります。カリフォルニアのサクラメントバレーは夏に乾燥しますが、貯水・灌漑が水を補います。どちらも、土地と水利の組み合わせが稲作の定着を支えています。"}]},
