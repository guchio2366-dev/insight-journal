...
export const cropExplanations = [
  ...
  ], uses: '搾油した大豆油と、油を取った後の大豆ミール。ミールは重要なたんぱく質飼料です。油は食品や燃料などに使われます。', sources: ['source-usda-midwest'] },
  ...
  ], uses: '生鮮食品、加工食品、果汁、ナッツ類など。生産や輸出の統計は、この総称ではなく代表的な個別品目で整理する予定です。', sources: ['source-usda-cdl-faq'] }
];
