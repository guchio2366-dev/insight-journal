import {populationViews,ethnicities} from '../data/atlas/population.ts';
import {populationCityProfiles} from '../data/atlas/population-reading.ts';
import {religionStoryIds,religionDominantCategories} from '../data/atlas/population-religion-reading.ts';
...
export function readPopulationState(url:URL){
 ...
 return {view,ethnicity:allowed('popEthnicity',ethnicities),religion:allowed('popReligion',religionDominantCategories),
